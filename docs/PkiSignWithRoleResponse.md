...
`func (o *PkiSignWithRoleResponse) GetExpiration() string`

GetExpiration returns the Expiration field if non-nil, zero value otherwise.

### GetExpirationOk

`func (o *PkiSignWithRoleResponse) GetExpirationOk() (*string, bool)`
...
`func (o *PkiSignWithRoleResponse) SetExpiration(v string)`
