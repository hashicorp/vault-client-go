...
`func (o *PkiIssuerSignWithRoleResponse) GetExpiration() string`

GetExpiration returns the Expiration field if non-nil, zero value otherwise.

### GetExpirationOk

`func (o *PkiIssuerSignWithRoleResponse) GetExpirationOk() (*string, bool)`
...
`func (o *PkiIssuerSignWithRoleResponse) SetExpiration(v string)`
