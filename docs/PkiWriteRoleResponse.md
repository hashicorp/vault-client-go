...
`func (o *PkiWriteRoleResponse) GetMaxTtl() int64`

GetMaxTtl returns the MaxTtl field if non-nil, zero value otherwise.

### GetMaxTtlOk

`func (o *PkiWriteRoleResponse) GetMaxTtlOk() (*int64, bool)`
...
`func (o *PkiWriteRoleResponse) SetMaxTtl(v int64)`
...
`func (o *PkiWriteRoleResponse) GetNotBeforeDuration() int64`

GetNotBeforeDuration returns the NotBeforeDuration field if non-nil, zero value otherwise.

### GetNotBeforeDurationOk

`func (o *PkiWriteRoleResponse) GetNotBeforeDurationOk() (*int64, bool)`
...
`func (o *PkiWriteRoleResponse) SetNotBeforeDuration(v int64)`
...
`func (o *PkiWriteRoleResponse) GetTtl() int64`

GetTtl returns the Ttl field if non-nil, zero value otherwise.

### GetTtlOk

`func (o *PkiWriteRoleResponse) GetTtlOk() (*int64, bool)`
...
`func (o *PkiWriteRoleResponse) SetTtl(v int64)`
