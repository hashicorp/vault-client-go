...
type ApiGetAuthGithubDuoConfigRequest struct {
	ctx context.Context
	ApiService *AuthApiService
}


func (r ApiGetAuthGithubDuoConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetAuthGithubDuoConfigExecute(r)
}

/*
GetAuthGithubDuoConfig Configure Duo second factor behavior.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetAuthGithubDuoConfigRequest
*/
func (a *AuthApiService) GetAuthGithubDuoConfig(ctx context.Context) ApiGetAuthGithubDuoConfigRequest {
	return ApiGetAuthGithubDuoConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) GetAuthGithubDuoConfigExecute(r ApiGetAuthGithubDuoConfigRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.GetAuthGithubDuoConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/auth/github/duo/config"
...
type ApiGetAuthGithubMfaConfigRequest struct {
	ctx context.Context
	ApiService *AuthApiService
}


func (r ApiGetAuthGithubMfaConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetAuthGithubMfaConfigExecute(r)
}

/*
GetAuthGithubMfaConfig Configure multi factor backend.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetAuthGithubMfaConfigRequest
*/
func (a *AuthApiService) GetAuthGithubMfaConfig(ctx context.Context) ApiGetAuthGithubMfaConfigRequest {
	return ApiGetAuthGithubMfaConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) GetAuthGithubMfaConfigExecute(r ApiGetAuthGithubMfaConfigRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.GetAuthGithubMfaConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/auth/github/mfa_config"
...
type ApiGetAuthLdapDuoConfigRequest struct {
	ctx context.Context
	ApiService *AuthApiService
}


func (r ApiGetAuthLdapDuoConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetAuthLdapDuoConfigExecute(r)
}

/*
GetAuthLdapDuoConfig Configure Duo second factor behavior.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetAuthLdapDuoConfigRequest
*/
func (a *AuthApiService) GetAuthLdapDuoConfig(ctx context.Context) ApiGetAuthLdapDuoConfigRequest {
	return ApiGetAuthLdapDuoConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) GetAuthLdapDuoConfigExecute(r ApiGetAuthLdapDuoConfigRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.GetAuthLdapDuoConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/auth/ldap/duo/config"
...
type ApiGetAuthLdapMfaConfigRequest struct {
	ctx context.Context
	ApiService *AuthApiService
}


func (r ApiGetAuthLdapMfaConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetAuthLdapMfaConfigExecute(r)
}

/*
GetAuthLdapMfaConfig Configure multi factor backend.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetAuthLdapMfaConfigRequest
*/
func (a *AuthApiService) GetAuthLdapMfaConfig(ctx context.Context) ApiGetAuthLdapMfaConfigRequest {
	return ApiGetAuthLdapMfaConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) GetAuthLdapMfaConfigExecute(r ApiGetAuthLdapMfaConfigRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.GetAuthLdapMfaConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/auth/ldap/mfa_config"
...
type ApiGetAuthOktaDuoConfigRequest struct {
	ctx context.Context
	ApiService *AuthApiService
}


func (r ApiGetAuthOktaDuoConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetAuthOktaDuoConfigExecute(r)
}

/*
GetAuthOktaDuoConfig Configure Duo second factor behavior.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetAuthOktaDuoConfigRequest
*/
func (a *AuthApiService) GetAuthOktaDuoConfig(ctx context.Context) ApiGetAuthOktaDuoConfigRequest {
	return ApiGetAuthOktaDuoConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) GetAuthOktaDuoConfigExecute(r ApiGetAuthOktaDuoConfigRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.GetAuthOktaDuoConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/auth/okta/duo/config"
...
type ApiGetAuthOktaMfaConfigRequest struct {
	ctx context.Context
	ApiService *AuthApiService
}


func (r ApiGetAuthOktaMfaConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetAuthOktaMfaConfigExecute(r)
}

/*
GetAuthOktaMfaConfig Configure multi factor backend.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetAuthOktaMfaConfigRequest
*/
func (a *AuthApiService) GetAuthOktaMfaConfig(ctx context.Context) ApiGetAuthOktaMfaConfigRequest {
	return ApiGetAuthOktaMfaConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) GetAuthOktaMfaConfigExecute(r ApiGetAuthOktaMfaConfigRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.GetAuthOktaMfaConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/auth/okta/mfa_config"
...
type ApiGetAuthRadiusDuoConfigRequest struct {
	ctx context.Context
	ApiService *AuthApiService
}


func (r ApiGetAuthRadiusDuoConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetAuthRadiusDuoConfigExecute(r)
}

/*
GetAuthRadiusDuoConfig Configure Duo second factor behavior.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetAuthRadiusDuoConfigRequest
*/
func (a *AuthApiService) GetAuthRadiusDuoConfig(ctx context.Context) ApiGetAuthRadiusDuoConfigRequest {
	return ApiGetAuthRadiusDuoConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) GetAuthRadiusDuoConfigExecute(r ApiGetAuthRadiusDuoConfigRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.GetAuthRadiusDuoConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/auth/radius/duo/config"
...
type ApiGetAuthRadiusMfaConfigRequest struct {
	ctx context.Context
	ApiService *AuthApiService
}


func (r ApiGetAuthRadiusMfaConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetAuthRadiusMfaConfigExecute(r)
}

/*
GetAuthRadiusMfaConfig Configure multi factor backend.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetAuthRadiusMfaConfigRequest
*/
func (a *AuthApiService) GetAuthRadiusMfaConfig(ctx context.Context) ApiGetAuthRadiusMfaConfigRequest {
	return ApiGetAuthRadiusMfaConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) GetAuthRadiusMfaConfigExecute(r ApiGetAuthRadiusMfaConfigRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.GetAuthRadiusMfaConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/auth/radius/mfa_config"
...
type ApiGetAuthUserpassDuoConfigRequest struct {
	ctx context.Context
	ApiService *AuthApiService
}


func (r ApiGetAuthUserpassDuoConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetAuthUserpassDuoConfigExecute(r)
}

/*
GetAuthUserpassDuoConfig Configure Duo second factor behavior.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetAuthUserpassDuoConfigRequest
*/
func (a *AuthApiService) GetAuthUserpassDuoConfig(ctx context.Context) ApiGetAuthUserpassDuoConfigRequest {
	return ApiGetAuthUserpassDuoConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) GetAuthUserpassDuoConfigExecute(r ApiGetAuthUserpassDuoConfigRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.GetAuthUserpassDuoConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/auth/userpass/duo/config"
...
type ApiGetAuthUserpassMfaConfigRequest struct {
	ctx context.Context
	ApiService *AuthApiService
}


func (r ApiGetAuthUserpassMfaConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetAuthUserpassMfaConfigExecute(r)
}

/*
GetAuthUserpassMfaConfig Configure multi factor backend.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetAuthUserpassMfaConfigRequest
*/
func (a *AuthApiService) GetAuthUserpassMfaConfig(ctx context.Context) ApiGetAuthUserpassMfaConfigRequest {
	return ApiGetAuthUserpassMfaConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) GetAuthUserpassMfaConfigExecute(r ApiGetAuthUserpassMfaConfigRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.GetAuthUserpassMfaConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/auth/userpass/mfa_config"
...
type ApiPostAuthGithubDuoAccessRequest struct {
	ctx context.Context
	ApiService *AuthApiService
	githubDuoAccessRequest *GithubDuoAccessRequest
}

func (r ApiPostAuthGithubDuoAccessRequest) GithubDuoAccessRequest(githubDuoAccessRequest GithubDuoAccessRequest) ApiPostAuthGithubDuoAccessRequest {
	r.githubDuoAccessRequest = &githubDuoAccessRequest
	return r
}

func (r ApiPostAuthGithubDuoAccessRequest) Execute() (*http.Response, error) {
	return r.ApiService.PostAuthGithubDuoAccessExecute(r)
}

/*
PostAuthGithubDuoAccess Configure the access keys and host for Duo API connections.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPostAuthGithubDuoAccessRequest
*/
func (a *AuthApiService) PostAuthGithubDuoAccess(ctx context.Context) ApiPostAuthGithubDuoAccessRequest {
	return ApiPostAuthGithubDuoAccessRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) PostAuthGithubDuoAccessExecute(r ApiPostAuthGithubDuoAccessRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.PostAuthGithubDuoAccess")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/auth/github/duo/access"
	...
	// body params
	localVarPostBody = r.githubDuoAccessRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
type ApiPostAuthGithubDuoConfigRequest struct {
	ctx context.Context
	ApiService *AuthApiService
	githubDuoConfigRequest *GithubDuoConfigRequest
}

func (r ApiPostAuthGithubDuoConfigRequest) GithubDuoConfigRequest(githubDuoConfigRequest GithubDuoConfigRequest) ApiPostAuthGithubDuoConfigRequest {
	r.githubDuoConfigRequest = &githubDuoConfigRequest
	return r
}

func (r ApiPostAuthGithubDuoConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.PostAuthGithubDuoConfigExecute(r)
}

/*
PostAuthGithubDuoConfig Configure Duo second factor behavior.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPostAuthGithubDuoConfigRequest
*/
func (a *AuthApiService) PostAuthGithubDuoConfig(ctx context.Context) ApiPostAuthGithubDuoConfigRequest {
	return ApiPostAuthGithubDuoConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) PostAuthGithubDuoConfigExecute(r ApiPostAuthGithubDuoConfigRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.PostAuthGithubDuoConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	// body params
	localVarPostBody = r.githubDuoConfigRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
type ApiPostAuthGithubMfaConfigRequest struct {
	ctx context.Context
	ApiService *AuthApiService
	githubMfaConfigRequest *GithubMfaConfigRequest
}

func (r ApiPostAuthGithubMfaConfigRequest) GithubMfaConfigRequest(githubMfaConfigRequest GithubMfaConfigRequest) ApiPostAuthGithubMfaConfigRequest {
	r.githubMfaConfigRequest = &githubMfaConfigRequest
	return r
}

func (r ApiPostAuthGithubMfaConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.PostAuthGithubMfaConfigExecute(r)
}

/*
PostAuthGithubMfaConfig Configure multi factor backend.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPostAuthGithubMfaConfigRequest
*/
func (a *AuthApiService) PostAuthGithubMfaConfig(ctx context.Context) ApiPostAuthGithubMfaConfigRequest {
	return ApiPostAuthGithubMfaConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) PostAuthGithubMfaConfigExecute(r ApiPostAuthGithubMfaConfigRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.PostAuthGithubMfaConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	// body params
	localVarPostBody = r.githubMfaConfigRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
type ApiPostAuthLdapDuoAccessRequest struct {
	ctx context.Context
	ApiService *AuthApiService
	ldapDuoAccessRequest *LdapDuoAccessRequest
}

func (r ApiPostAuthLdapDuoAccessRequest) LdapDuoAccessRequest(ldapDuoAccessRequest LdapDuoAccessRequest) ApiPostAuthLdapDuoAccessRequest {
	r.ldapDuoAccessRequest = &ldapDuoAccessRequest
	return r
}

func (r ApiPostAuthLdapDuoAccessRequest) Execute() (*http.Response, error) {
	return r.ApiService.PostAuthLdapDuoAccessExecute(r)
}

/*
PostAuthLdapDuoAccess Configure the access keys and host for Duo API connections.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPostAuthLdapDuoAccessRequest
*/
func (a *AuthApiService) PostAuthLdapDuoAccess(ctx context.Context) ApiPostAuthLdapDuoAccessRequest {
	return ApiPostAuthLdapDuoAccessRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) PostAuthLdapDuoAccessExecute(r ApiPostAuthLdapDuoAccessRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.PostAuthLdapDuoAccess")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/auth/ldap/duo/access"
	...
	// body params
	localVarPostBody = r.ldapDuoAccessRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
type ApiPostAuthLdapDuoConfigRequest struct {
	ctx context.Context
	ApiService *AuthApiService
	ldapDuoConfigRequest *LdapDuoConfigRequest
}

func (r ApiPostAuthLdapDuoConfigRequest) LdapDuoConfigRequest(ldapDuoConfigRequest LdapDuoConfigRequest) ApiPostAuthLdapDuoConfigRequest {
	r.ldapDuoConfigRequest = &ldapDuoConfigRequest
	return r
}

func (r ApiPostAuthLdapDuoConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.PostAuthLdapDuoConfigExecute(r)
}

/*
PostAuthLdapDuoConfig Configure Duo second factor behavior.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPostAuthLdapDuoConfigRequest
*/
func (a *AuthApiService) PostAuthLdapDuoConfig(ctx context.Context) ApiPostAuthLdapDuoConfigRequest {
	return ApiPostAuthLdapDuoConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) PostAuthLdapDuoConfigExecute(r ApiPostAuthLdapDuoConfigRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.PostAuthLdapDuoConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	// body params
	localVarPostBody = r.ldapDuoConfigRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
type ApiPostAuthLdapMfaConfigRequest struct {
	ctx context.Context
	ApiService *AuthApiService
	ldapMfaConfigRequest *LdapMfaConfigRequest
}

func (r ApiPostAuthLdapMfaConfigRequest) LdapMfaConfigRequest(ldapMfaConfigRequest LdapMfaConfigRequest) ApiPostAuthLdapMfaConfigRequest {
	r.ldapMfaConfigRequest = &ldapMfaConfigRequest
	return r
}

func (r ApiPostAuthLdapMfaConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.PostAuthLdapMfaConfigExecute(r)
}

/*
PostAuthLdapMfaConfig Configure multi factor backend.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPostAuthLdapMfaConfigRequest
*/
func (a *AuthApiService) PostAuthLdapMfaConfig(ctx context.Context) ApiPostAuthLdapMfaConfigRequest {
	return ApiPostAuthLdapMfaConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) PostAuthLdapMfaConfigExecute(r ApiPostAuthLdapMfaConfigRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.PostAuthLdapMfaConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	// body params
	localVarPostBody = r.ldapMfaConfigRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
type ApiPostAuthOktaDuoAccessRequest struct {
	ctx context.Context
	ApiService *AuthApiService
	oktaDuoAccessRequest *OktaDuoAccessRequest
}

func (r ApiPostAuthOktaDuoAccessRequest) OktaDuoAccessRequest(oktaDuoAccessRequest OktaDuoAccessRequest) ApiPostAuthOktaDuoAccessRequest {
	r.oktaDuoAccessRequest = &oktaDuoAccessRequest
	return r
}

func (r ApiPostAuthOktaDuoAccessRequest) Execute() (*http.Response, error) {
	return r.ApiService.PostAuthOktaDuoAccessExecute(r)
}

/*
PostAuthOktaDuoAccess Configure the access keys and host for Duo API connections.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPostAuthOktaDuoAccessRequest
*/
func (a *AuthApiService) PostAuthOktaDuoAccess(ctx context.Context) ApiPostAuthOktaDuoAccessRequest {
	return ApiPostAuthOktaDuoAccessRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) PostAuthOktaDuoAccessExecute(r ApiPostAuthOktaDuoAccessRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.PostAuthOktaDuoAccess")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/auth/okta/duo/access"
	...
	// body params
	localVarPostBody = r.oktaDuoAccessRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
type ApiPostAuthOktaDuoConfigRequest struct {
	ctx context.Context
	ApiService *AuthApiService
	oktaDuoConfigRequest *OktaDuoConfigRequest
}

func (r ApiPostAuthOktaDuoConfigRequest) OktaDuoConfigRequest(oktaDuoConfigRequest OktaDuoConfigRequest) ApiPostAuthOktaDuoConfigRequest {
	r.oktaDuoConfigRequest = &oktaDuoConfigRequest
	return r
}

func (r ApiPostAuthOktaDuoConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.PostAuthOktaDuoConfigExecute(r)
}

/*
PostAuthOktaDuoConfig Configure Duo second factor behavior.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPostAuthOktaDuoConfigRequest
*/
func (a *AuthApiService) PostAuthOktaDuoConfig(ctx context.Context) ApiPostAuthOktaDuoConfigRequest {
	return ApiPostAuthOktaDuoConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) PostAuthOktaDuoConfigExecute(r ApiPostAuthOktaDuoConfigRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.PostAuthOktaDuoConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	// body params
	localVarPostBody = r.oktaDuoConfigRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
type ApiPostAuthOktaMfaConfigRequest struct {
	ctx context.Context
	ApiService *AuthApiService
	oktaMfaConfigRequest *OktaMfaConfigRequest
}

func (r ApiPostAuthOktaMfaConfigRequest) OktaMfaConfigRequest(oktaMfaConfigRequest OktaMfaConfigRequest) ApiPostAuthOktaMfaConfigRequest {
	r.oktaMfaConfigRequest = &oktaMfaConfigRequest
	return r
}

func (r ApiPostAuthOktaMfaConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.PostAuthOktaMfaConfigExecute(r)
}

/*
PostAuthOktaMfaConfig Configure multi factor backend.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPostAuthOktaMfaConfigRequest
*/
func (a *AuthApiService) PostAuthOktaMfaConfig(ctx context.Context) ApiPostAuthOktaMfaConfigRequest {
	return ApiPostAuthOktaMfaConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) PostAuthOktaMfaConfigExecute(r ApiPostAuthOktaMfaConfigRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.PostAuthOktaMfaConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	// body params
	localVarPostBody = r.oktaMfaConfigRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
type ApiPostAuthRadiusDuoAccessRequest struct {
	ctx context.Context
	ApiService *AuthApiService
	radiusDuoAccessRequest *RadiusDuoAccessRequest
}

func (r ApiPostAuthRadiusDuoAccessRequest) RadiusDuoAccessRequest(radiusDuoAccessRequest RadiusDuoAccessRequest) ApiPostAuthRadiusDuoAccessRequest {
	r.radiusDuoAccessRequest = &radiusDuoAccessRequest
	return r
}

func (r ApiPostAuthRadiusDuoAccessRequest) Execute() (*http.Response, error) {
	return r.ApiService.PostAuthRadiusDuoAccessExecute(r)
}

/*
PostAuthRadiusDuoAccess Configure the access keys and host for Duo API connections.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPostAuthRadiusDuoAccessRequest
*/
func (a *AuthApiService) PostAuthRadiusDuoAccess(ctx context.Context) ApiPostAuthRadiusDuoAccessRequest {
	return ApiPostAuthRadiusDuoAccessRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) PostAuthRadiusDuoAccessExecute(r ApiPostAuthRadiusDuoAccessRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.PostAuthRadiusDuoAccess")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/auth/radius/duo/access"
	...
	// body params
	localVarPostBody = r.radiusDuoAccessRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
type ApiPostAuthRadiusDuoConfigRequest struct {
	ctx context.Context
	ApiService *AuthApiService
	radiusDuoConfigRequest *RadiusDuoConfigRequest
}

func (r ApiPostAuthRadiusDuoConfigRequest) RadiusDuoConfigRequest(radiusDuoConfigRequest RadiusDuoConfigRequest) ApiPostAuthRadiusDuoConfigRequest {
	r.radiusDuoConfigRequest = &radiusDuoConfigRequest
	return r
}

func (r ApiPostAuthRadiusDuoConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.PostAuthRadiusDuoConfigExecute(r)
}

/*
PostAuthRadiusDuoConfig Configure Duo second factor behavior.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPostAuthRadiusDuoConfigRequest
*/
func (a *AuthApiService) PostAuthRadiusDuoConfig(ctx context.Context) ApiPostAuthRadiusDuoConfigRequest {
	return ApiPostAuthRadiusDuoConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) PostAuthRadiusDuoConfigExecute(r ApiPostAuthRadiusDuoConfigRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.PostAuthRadiusDuoConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	// body params
	localVarPostBody = r.radiusDuoConfigRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
type ApiPostAuthRadiusMfaConfigRequest struct {
	ctx context.Context
	ApiService *AuthApiService
	radiusMfaConfigRequest *RadiusMfaConfigRequest
}

func (r ApiPostAuthRadiusMfaConfigRequest) RadiusMfaConfigRequest(radiusMfaConfigRequest RadiusMfaConfigRequest) ApiPostAuthRadiusMfaConfigRequest {
	r.radiusMfaConfigRequest = &radiusMfaConfigRequest
	return r
}

func (r ApiPostAuthRadiusMfaConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.PostAuthRadiusMfaConfigExecute(r)
}

/*
PostAuthRadiusMfaConfig Configure multi factor backend.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPostAuthRadiusMfaConfigRequest
*/
func (a *AuthApiService) PostAuthRadiusMfaConfig(ctx context.Context) ApiPostAuthRadiusMfaConfigRequest {
	return ApiPostAuthRadiusMfaConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) PostAuthRadiusMfaConfigExecute(r ApiPostAuthRadiusMfaConfigRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.PostAuthRadiusMfaConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	// body params
	localVarPostBody = r.radiusMfaConfigRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
type ApiPostAuthUserpassDuoAccessRequest struct {
	ctx context.Context
	ApiService *AuthApiService
	userpassDuoAccessRequest *UserpassDuoAccessRequest
}

func (r ApiPostAuthUserpassDuoAccessRequest) UserpassDuoAccessRequest(userpassDuoAccessRequest UserpassDuoAccessRequest) ApiPostAuthUserpassDuoAccessRequest {
	r.userpassDuoAccessRequest = &userpassDuoAccessRequest
	return r
}

func (r ApiPostAuthUserpassDuoAccessRequest) Execute() (*http.Response, error) {
	return r.ApiService.PostAuthUserpassDuoAccessExecute(r)
}

/*
PostAuthUserpassDuoAccess Configure the access keys and host for Duo API connections.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPostAuthUserpassDuoAccessRequest
*/
func (a *AuthApiService) PostAuthUserpassDuoAccess(ctx context.Context) ApiPostAuthUserpassDuoAccessRequest {
	return ApiPostAuthUserpassDuoAccessRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) PostAuthUserpassDuoAccessExecute(r ApiPostAuthUserpassDuoAccessRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.PostAuthUserpassDuoAccess")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/auth/userpass/duo/access"
	...
	// body params
	localVarPostBody = r.userpassDuoAccessRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
type ApiPostAuthUserpassDuoConfigRequest struct {
	ctx context.Context
	ApiService *AuthApiService
	userpassDuoConfigRequest *UserpassDuoConfigRequest
}

func (r ApiPostAuthUserpassDuoConfigRequest) UserpassDuoConfigRequest(userpassDuoConfigRequest UserpassDuoConfigRequest) ApiPostAuthUserpassDuoConfigRequest {
	r.userpassDuoConfigRequest = &userpassDuoConfigRequest
	return r
}

func (r ApiPostAuthUserpassDuoConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.PostAuthUserpassDuoConfigExecute(r)
}

/*
PostAuthUserpassDuoConfig Configure Duo second factor behavior.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPostAuthUserpassDuoConfigRequest
*/
func (a *AuthApiService) PostAuthUserpassDuoConfig(ctx context.Context) ApiPostAuthUserpassDuoConfigRequest {
	return ApiPostAuthUserpassDuoConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) PostAuthUserpassDuoConfigExecute(r ApiPostAuthUserpassDuoConfigRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.PostAuthUserpassDuoConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	// body params
	localVarPostBody = r.userpassDuoConfigRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
type ApiPostAuthUserpassMfaConfigRequest struct {
	ctx context.Context
	ApiService *AuthApiService
	userpassMfaConfigRequest *UserpassMfaConfigRequest
}

func (r ApiPostAuthUserpassMfaConfigRequest) UserpassMfaConfigRequest(userpassMfaConfigRequest UserpassMfaConfigRequest) ApiPostAuthUserpassMfaConfigRequest {
	r.userpassMfaConfigRequest = &userpassMfaConfigRequest
	return r
}

func (r ApiPostAuthUserpassMfaConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.PostAuthUserpassMfaConfigExecute(r)
}

/*
PostAuthUserpassMfaConfig Configure multi factor backend.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPostAuthUserpassMfaConfigRequest
*/
func (a *AuthApiService) PostAuthUserpassMfaConfig(ctx context.Context) ApiPostAuthUserpassMfaConfigRequest {
	return ApiPostAuthUserpassMfaConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) PostAuthUserpassMfaConfigExecute(r ApiPostAuthUserpassMfaConfigRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.PostAuthUserpassMfaConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	// body params
	localVarPostBody = r.userpassMfaConfigRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
