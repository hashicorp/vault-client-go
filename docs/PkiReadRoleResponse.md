...
`func (o *PkiReadRoleResponse) GetMaxTtl() int64`

GetMaxTtl returns the MaxTtl field if non-nil, zero value otherwise.

### GetMaxTtlOk

`func (o *PkiReadRoleResponse) GetMaxTtlOk() (*int64, bool)`
...
`func (o *PkiReadRoleResponse) SetMaxTtl(v int64)`
...
`func (o *PkiReadRoleResponse) GetNotBeforeDuration() int64`

GetNotBeforeDuration returns the NotBeforeDuration field if non-nil, zero value otherwise.

### GetNotBeforeDurationOk

`func (o *PkiReadRoleResponse) GetNotBeforeDurationOk() (*int64, bool)`
...
`func (o *PkiReadRoleResponse) SetNotBeforeDuration(v int64)`
...
`func (o *PkiReadRoleResponse) GetTtl() int64`

GetTtl returns the Ttl field if non-nil, zero value otherwise.

### GetTtlOk

`func (o *PkiReadRoleResponse) GetTtlOk() (*int64, bool)`
...
`func (o *PkiReadRoleResponse) SetTtl(v int64)`
