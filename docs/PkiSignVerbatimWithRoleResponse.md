...
`func (o *PkiSignVerbatimWithRoleResponse) GetExpiration() int64`

GetExpiration returns the Expiration field if non-nil, zero value otherwise.

### GetExpirationOk

`func (o *PkiSignVerbatimWithRoleResponse) GetExpirationOk() (*int64, bool)`
...
`func (o *PkiSignVerbatimWithRoleResponse) SetExpiration(v int64)`
