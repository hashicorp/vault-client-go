...
`func (o *PkiIssuerSignWithRoleRequest) GetTtl() string`

GetTtl returns the Ttl field if non-nil, zero value otherwise.

### GetTtlOk

`func (o *PkiIssuerSignWithRoleRequest) GetTtlOk() (*string, bool)`
...
`func (o *PkiIssuerSignWithRoleRequest) SetTtl(v string)`
