...
`func (o *PkiSignVerbatimWithRoleRequest) GetTtl() string`

GetTtl returns the Ttl field if non-nil, zero value otherwise.

### GetTtlOk

`func (o *PkiSignVerbatimWithRoleRequest) GetTtlOk() (*string, bool)`
...
`func (o *PkiSignVerbatimWithRoleRequest) SetTtl(v string)`
