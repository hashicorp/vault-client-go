...
`func (o *PkiConfigAutoTidyRequest) GetIssuerSafetyBuffer() int32`

GetIssuerSafetyBuffer returns the IssuerSafetyBuffer field if non-nil, zero value otherwise.

### GetIssuerSafetyBufferOk

`func (o *PkiConfigAutoTidyRequest) GetIssuerSafetyBufferOk() (*int32, bool)`
...
`func (o *PkiConfigAutoTidyRequest) SetIssuerSafetyBuffer(v int32)`

SetIssuerSafetyBuffer sets IssuerSafetyBuffer field to given value.

### HasIssuerSafetyBuffer

`func (o *PkiConfigAutoTidyRequest) HasIssuerSafetyBuffer() bool`
...
`func (o *PkiConfigAutoTidyRequest) GetTidyExpiredIssuers() bool`

GetTidyExpiredIssuers returns the TidyExpiredIssuers field if non-nil, zero value otherwise.

### GetTidyExpiredIssuersOk

`func (o *PkiConfigAutoTidyRequest) GetTidyExpiredIssuersOk() (*bool, bool)`
...
`func (o *PkiConfigAutoTidyRequest) SetTidyExpiredIssuers(v bool)`

SetTidyExpiredIssuers sets TidyExpiredIssuers field to given value.

### HasTidyExpiredIssuers

`func (o *PkiConfigAutoTidyRequest) HasTidyExpiredIssuers() bool`
