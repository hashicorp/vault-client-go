...
type LdapConfigureRequest struct {
	...
	DereferenceAliases string `json:"dereference_aliases"`
...
func (o LdapConfigureRequest) MarshalJSON() ([]byte, error) {
	...
	toSerialize["dereference_aliases"] = o.DereferenceAliases
