...
`func (o *PkiIssuerSignVerbatimResponse) GetExpiration() string`

GetExpiration returns the Expiration field if non-nil, zero value otherwise.

### GetExpirationOk

`func (o *PkiIssuerSignVerbatimResponse) GetExpirationOk() (*string, bool)`
...
`func (o *PkiIssuerSignVerbatimResponse) SetExpiration(v string)`
