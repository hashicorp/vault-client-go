...
// applyTLSConfig applies the user-configured TLS config to the client's *tls.Config pointer
func applyTLSConfig(to *tls.Config, from TLSConfig) error {
