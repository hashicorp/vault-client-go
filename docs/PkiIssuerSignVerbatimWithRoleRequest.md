...
`func (o *PkiIssuerSignVerbatimWithRoleRequest) GetTtl() string`

GetTtl returns the Ttl field if non-nil, zero value otherwise.

### GetTtlOk

`func (o *PkiIssuerSignVerbatimWithRoleRequest) GetTtlOk() (*string, bool)`
...
`func (o *PkiIssuerSignVerbatimWithRoleRequest) SetTtl(v string)`
