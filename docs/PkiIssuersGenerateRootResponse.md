...
`func (o *PkiIssuersGenerateRootResponse) GetExpiration() string`

GetExpiration returns the Expiration field if non-nil, zero value otherwise.

### GetExpirationOk

`func (o *PkiIssuersGenerateRootResponse) GetExpirationOk() (*string, bool)`
...
`func (o *PkiIssuersGenerateRootResponse) SetExpiration(v string)`
