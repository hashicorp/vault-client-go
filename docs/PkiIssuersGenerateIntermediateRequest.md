...
`func (o *PkiIssuersGenerateIntermediateRequest) GetNotBeforeDuration() string`

GetNotBeforeDuration returns the NotBeforeDuration field if non-nil, zero value otherwise.

### GetNotBeforeDurationOk

`func (o *PkiIssuersGenerateIntermediateRequest) GetNotBeforeDurationOk() (*string, bool)`
...
`func (o *PkiIssuersGenerateIntermediateRequest) SetNotBeforeDuration(v string)`
...
`func (o *PkiIssuersGenerateIntermediateRequest) GetTtl() string`

GetTtl returns the Ttl field if non-nil, zero value otherwise.

### GetTtlOk

`func (o *PkiIssuersGenerateIntermediateRequest) GetTtlOk() (*string, bool)`
...
`func (o *PkiIssuersGenerateIntermediateRequest) SetTtl(v string)`
