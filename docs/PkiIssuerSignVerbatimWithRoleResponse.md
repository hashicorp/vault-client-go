...
`func (o *PkiIssuerSignVerbatimWithRoleResponse) GetExpiration() int64`

GetExpiration returns the Expiration field if non-nil, zero value otherwise.

### GetExpirationOk

`func (o *PkiIssuerSignVerbatimWithRoleResponse) GetExpirationOk() (*int64, bool)`
...
`func (o *PkiIssuerSignVerbatimWithRoleResponse) SetExpiration(v int64)`
