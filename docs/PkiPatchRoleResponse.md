...
`func (o *PkiPatchRoleResponse) GetMaxTtl() int32`

GetMaxTtl returns the MaxTtl field if non-nil, zero value otherwise.

### GetMaxTtlOk

`func (o *PkiPatchRoleResponse) GetMaxTtlOk() (*int32, bool)`
...
`func (o *PkiPatchRoleResponse) SetMaxTtl(v int32)`
...
`func (o *PkiPatchRoleResponse) GetNotBeforeDuration() int32`

GetNotBeforeDuration returns the NotBeforeDuration field if non-nil, zero value otherwise.

### GetNotBeforeDurationOk

`func (o *PkiPatchRoleResponse) GetNotBeforeDurationOk() (*int32, bool)`
...
`func (o *PkiPatchRoleResponse) SetNotBeforeDuration(v int32)`
...
`func (o *PkiPatchRoleResponse) GetTtl() int32`

GetTtl returns the Ttl field if non-nil, zero value otherwise.

### GetTtlOk

`func (o *PkiPatchRoleResponse) GetTtlOk() (*int32, bool)`
...
`func (o *PkiPatchRoleResponse) SetTtl(v int32)`
