...
// GithubDuoConfigRequest struct for GithubDuoConfigRequest
type GithubDuoConfigRequest struct {
...
func (o GithubDuoConfigRequest) MarshalJSON() ([]byte, error) {
...
type NullableGithubDuoConfigRequest struct {
	value *GithubDuoConfigRequest
	isSet bool
}

func (v NullableGithubDuoConfigRequest) Get() *GithubDuoConfigRequest {
	return v.value
}

func (v *NullableGithubDuoConfigRequest) Set(val *GithubDuoConfigRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGithubDuoConfigRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGithubDuoConfigRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGithubDuoConfigRequest(val *GithubDuoConfigRequest) *NullableGithubDuoConfigRequest {
	return &NullableGithubDuoConfigRequest{value: val, isSet: true}
}

func (v NullableGithubDuoConfigRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGithubDuoConfigRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
