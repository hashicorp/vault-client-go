...
`func (o *PkiIssuerIssueWithRoleResponse) GetExpiration() int64`

GetExpiration returns the Expiration field if non-nil, zero value otherwise.

### GetExpirationOk

`func (o *PkiIssuerIssueWithRoleResponse) GetExpirationOk() (*int64, bool)`
...
`func (o *PkiIssuerIssueWithRoleResponse) SetExpiration(v int64)`
