...
**DefaultTtl** | Pointer to **int32** | Default ttl for role. | [optional] 
**MaxTtl** | Pointer to **int32** | Maximum time a credential is valid for | [optional] 
...
`func (o *DatabaseWriteRoleRequest) GetDefaultTtl() int32`

GetDefaultTtl returns the DefaultTtl field if non-nil, zero value otherwise.

### GetDefaultTtlOk

`func (o *DatabaseWriteRoleRequest) GetDefaultTtlOk() (*int32, bool)`
...
`func (o *DatabaseWriteRoleRequest) SetDefaultTtl(v int32)`
...
`func (o *DatabaseWriteRoleRequest) GetMaxTtl() int32`

GetMaxTtl returns the MaxTtl field if non-nil, zero value otherwise.

### GetMaxTtlOk

`func (o *DatabaseWriteRoleRequest) GetMaxTtlOk() (*int32, bool)`
...
`func (o *DatabaseWriteRoleRequest) SetMaxTtl(v int32)`
